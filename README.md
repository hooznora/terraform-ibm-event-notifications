...
| <a name="input_cos_destination_name"></a> [cos\_destination\_name](#input\_cos\_destination\_name) | The name to give the IBM Cloud Object Storage destination which will be created for storage of failed delivery events. | `string` | `null` | no |
| <a name="input_cos_endpoint_type"></a> [cos\_endpoint\_type](#input\_cos\_endpoint\_type) | Whether you want to have the private or public endpoint for your bucket. | `string` | `null` | no |
...
| <a name="input_cos_region"></a> [cos\_region](#input\_cos\_region) | The region in which the cos bucket is located. | `string` | `null` | no |
