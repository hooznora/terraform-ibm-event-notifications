...
| <a name="input_cos_endpoint_type"></a> [cos\_endpoint\_type](#input\_cos\_endpoint\_type) | Whether you want to have the private or public endpoint for your bucket. | `string` | `"private"` | no |
